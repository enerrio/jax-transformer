# GPT-2 in Jax
---
This repo accompanies the [Equinox and Friends](https://enerrio.bearblog.dev/equinox-and-friends/) blog post and the [GPT-2 in Jax](https://enerrio.bearblog.dev/gpt2-in-jax/) blog post and the [Beautiful Progress Bars with Rich](https://enerrio.bearblog.dev/beautiful-progress-bars-in-rich/). Here's a description of each file:

* equinox_test.py: Code from `Equinox and Friends` blog post
* rich_progress_demo.py: Code from `Beautiful Progress Bars with Rich` blog post
